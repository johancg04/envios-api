...
@router.post('/v1/usuarios/login', response_model=None)
async def loguear_usuario(usuario_login: UsuarioLogin) -> dict:
    return usuario_service.loguear(usuario_login)
